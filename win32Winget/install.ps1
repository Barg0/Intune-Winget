...
$logFileDirectory = "$env:ProgramData\Microsoft\IntuneManagementExtension\Logs\Applications\$applicationName"
...
Write-Log "Preparing to install $applicationName" -Tag "Info"
...
try {
    ...
    Write-Log "Winget install command failed. Exception: $_" -Tag "Error"
    Complete-Script -ExitCode 1
}
